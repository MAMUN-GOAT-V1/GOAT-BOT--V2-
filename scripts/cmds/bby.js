  ...
  onChat: async function ({ api, event, message, usersData }) {
    ...
    try {
      ...
      if (simpleTriggers.includes(raw)) {
        await sendTyping();
        const replies = ["ডাকো কেন 🥺 প্রেম করবা নাকি 😞", "亗🅼🅰ᥫᩣ🅼ᥫᩣ🆄🅽×͜× কে দেখছো? 🥺 তাকে কোথাও খুজে পাচ্ছি না 😩", "কিরে নাগিনী এত ডাকিস কেন 😩😁", "5 taka de 😁", "亗🅼🅰ᥫᩣ🅼ᥫᩣ🆄🅽×͜× কে দেখছো? 🥺 তাকে কোথাও খুজে পাচ্ছি না 😩"," ঝাং তোমালে রাইতে ভালোপাসি🥺🤌", "হ্যাঁ গো জান বলো 🙂", "oi suno i love u"];
